...
`BaseAuthOIDCRoute` needs one more thing: since a single strategy class can front multiple providers, your subclass supplies which one by overriding `providerConfig`.
