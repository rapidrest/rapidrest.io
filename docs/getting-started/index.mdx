...
`/push` (and `/acls`, if you kept a database selected) — thin subclasses of the framework's [Base Routes](/docs/base-routes) that you're free to
edit, lock down, or delete.
...
- [Base Routes](/docs/base-routes) — what the generated `AdminRoute`, `MetricsRoute`, `OpenAPIRoute`, `StatusRoute` and `PushRoute` files actually do
